...
<head>
    ...
    <head>
        ...
        <!-- My CSS -->
        <!-- My Angular App  -->
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js//app_ob//appController.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/app_ob/appService.js"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/app_ob/appDirectives.js"></script>
                    ...
                    <form ng-submit="appCtrl.createPerson()" class="form-signin" name="sendTest">
                        <div ng-if="!appCtrl.started">
                            ...
                            <div class="col s6 offset-s3 center">
                                <div class="col s12">
                                    <input placeholder="Enter your First Name" type="text" ng-model="appCtrl.name" required></input>
                                </div>
                                <div class="col s12">
                                    <input placeholder="Enter your Last Name" type="text" ng-model="appCtrl.lastname" required></input>
                                </div>
                                <div class="col s12">
                                    <input placeholder="Enter your Email" type="email" ng-model="appCtrl.email" required></input>
                                </div>
